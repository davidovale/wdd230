...
const lastModUser = document.querySelector(".lastModUser");
...
function Modification(){
    ...
    document.querySelector(".lastModification").innerHTML = "Last Updated: " + lastModified;
    const lastMod = new Date(lastModified);
    const CurrentMod = currentDate();
    lastModUser.textContent = calculateDate(CurrentMod, lastMod);
    //document.querySelector("#copy").innerHTML = "&copy;"
    //document.querySelector('#year').innerHTML = new Date(Date.now()).getFullYear();
  }
